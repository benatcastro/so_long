...
/*   Updated: 2022/07/18 16:29:37 by bena             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (error_key == 0)
		perror("Error: map doesn't have any character ❌\n");
	else if (error_key == 1)
		perror("Error: map doesn't have any exit point ❌\n");
	else if (error_key == 2)
		perror("Error: map doesn't have any collectable ❌\n");
	exit (EXIT_FAILURE);
}
